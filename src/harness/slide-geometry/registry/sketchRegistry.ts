...
import {page19R1Sketch} from "../contracts/page19-r1";
...
const SKETCH_REGISTRY: Record<string, GeometrySketchDefinition> = {
  ...
  [page19R1Sketch.id]: page19R1Sketch,
};
...
export function listGeometrySketches(): GeometrySketchDefinition[] {
  return Object.values(SKETCH_REGISTRY);
}

export function findGeometrySketchByStepId(
  stepId: StoryStepId,
): GeometrySketchDefinition | undefined {
  return listGeometrySketches().find((sketch) => sketch.stepId === stepId);
}
