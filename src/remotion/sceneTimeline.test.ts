...
describe("remotion timeline", () => {
  it("extends the canonical step sequence through page 08", () => {
  ...
  it("assigns frame anchors for the shader zoom pages", () => {
  ...
  it("builds scene windows across the new zoom segment", () => {
